...
export const FIND_WIDGETS_BY_LESSON = 'FIND_WIDGETS_BY_LESSON'
export const ADD_WIDGET_BY_LESSON = 'ADD_WIDGET_BY_LESSON'

export const PARAGRAPH_TEXT_CHANGED = 'PARAGRAPH_TEXT_CHANGED'
export const PARAGRAPH_NAME_CHANGED = 'PARAGRAPH_NAME_CHANGED'

export const SAVE_WIDGETS_BY_LESSON = 'SAVE_WIDGETS_BY_LESSON'
